function Ceremony() {
  return (
    <section className="flex flex-col items-center justify-center " data-aos="fade-up">
      <h2 className="font-mirra text-[40px]" data-aos="fade-up">свадебная церемония</h2>

      <p className="font-actay-regular text-[16px] max-w-[363px] mx-auto mb-3 flex flex-col justify-center items-center uppercase" data-aos="fade-up">
        <span>ЗАГС</span>
      ...
      <a target="_blank" href="https://yandex.ru/maps/-/CLwIe2PW"
         className="font-cormorant font-normal bg-primary-dark py-2 px-5 rounded-xl uppercase text-white text-[16px] block mb-4"
         data-aos="fade-up"
      >посмотреть на карте</a>

      <p className="font-actay-regular text-[16px] max-w-[363px] mx-auto flex flex-col justify-center items-center " data-aos="fade-up">
        Сбор гостей
      </p>
      ...
      <p className="font-actay-regular text-[16px] max-w-[363px] mx-auto flex flex-col justify-center items-center leading-5 mb-5" data-aos="fade-up">
